  ...
  return (
    ...
    >
       ...
       <div style={{ display: "flex" }}>
        ...
        (chatGptResponse.type === "guide" || chatGptResponse.type === "ask" || chatGptResponse.type === "quiz") ? (
          ...
          ((chatGptResponse.response &&  chatGptResponse.type === 'summarize') ||
            (chatGptResponse.response && chatGptResponse.type === 'define') ||
            (chatGptResponse.response && chatGptResponse.type === 'inspire') ||
            (chatGptResponse.response && chatGptResponse.type === 'patreon') ||
            (chatGptResponse.response && chatGptResponse.type === 'market') ||
            (chatGptResponse.response && chatGptResponse.type === 'demonstrate') ||
            (chatGptResponse.response && chatGptResponse.type === 'anything')) ? (
