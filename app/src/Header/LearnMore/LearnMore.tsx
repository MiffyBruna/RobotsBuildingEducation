        ...
        >
          <div style={{ maxWidth: "100%", width: 700 }}>
            ...
            >
              ...
              <ol>
                ...
                <li>
                  ...
                  happens on social media. Unrecorded education or learning is a
                  systemic failure.
                </li>
            ...
            >
              <b>
                ...
                about what I teach, please continue to explore. Visit the
                Patreon to subscribe and get a shareable passcode to enter the
                app.
              </b>
            </p>
          </div>
          ...
          <div style={{ maxWidth: "100%", width: 700 }}>
            ...
            >
              ...
              the best answer many times, because it's worth informing you as a
              beginner.
            </p>
            <br />
            <div
            ...
            >
              ...
              <p style={{ maxWidth: "100%", width: 700 }}>
                When it comes to learning, I recommend paper and pencil. RO.B.E
                is not a software intensive program. It can be used on your
                mobile device or any laptop. I like it on mobile phones.
                <br /> <br />
                ...
                and macbook pros are good general solutions to what you'll need
                in a number of careers. If you need something specialized for
                gaming or some AI and you're certain about your investment, then
                in a similar spirit, invest in the best computing power you can
                get.
                <br />
                <br />
                But what if you're in a budget? In that case, any laptop will do
                for what's being taught here. You can even get away with doing
                something on an ipad these days, with how some web services like
                Github Codespaces or Codepen has improved over the years.
            ...
            >
              ...
              <p style={{ maxWidth: "100%", width: 700 }}>
                ...
                going to encourage you to heal the trauma you've experienced in
                your classrooms regarding math. It happened to me too. You're
                safe here and I'll explain how.
                <br />
                <br />
                To answer your question, no. You don't have to be good at math.
                And programming isn't hard, it's challenging. It's about
                organizing information. Now to address you question - you learn
                a lot more than just coding here and you should know that you
                can accomplish the things you want to accomplish. There are many
                days where I wish I was a better drawer and I'm sure if you
                looked at me you'd feel confident I could achieve that. I feel
                that way about math to you. Maybe no one made you understand why
                it's important - for me it gave me access to freedom and what I
                feel is the deepest understanding the universe has to offer. And
                with that I could do anything. So I was willing to fail for
                that.
                <br />
                <br />
                ...
                emotional, but that's part of the fun too. I'm here to tell you
                that I want you to learn more than just coding, coding is just a
                medium for that feeling I want you to experience from learning.
              </p>
            </div>
            <br />
            <br />
            ...
            >
              ...
              <p style={{ maxWidth: "100%", width: 700 }}>
                ...
                across Python and Javascript. They're very popular for a reason,
                but before explaining why, I strongly recommend to think about
                what kind of machines you want to work on and what kind of
                problems you want to solve. You can answer that deeply or as
                strategically as you want, but either way answering those
                questions will get you the best answer to this question.
                <br />
                <br />
                The reason Javascript and Python are so widespread is because of
                the internet. They're mostly used to answer to do a lot of the
                service work of the internet, like how we could our web browsers
                or how we code the cloud.
                <br />
                <br />
                What what if you need and iOS app, an android one, a video game,
                or some kind of robot? Ultimately you'll find that when you
                "learn one language, you kinda learn them all". Again, there's a
                reason for that, but ultimately it's like worrying whether you
                should learn how to use a hammer or drill when building a home,
                you're likely going to use both eventually and it'll feel pretty
                familiar.
              </p>
            </div>
            <br />
            ...
            >
              ...
              <p style={{ maxWidth: "100%", width: 700 }}>
                ...
                recommend bootcamps if the value of your time is extremely high.
                For example, you need to take care of a newborn child and want
                to create more time and opportunity. Another example is that
                you're mental health is in decline, you have a healthy bank
                account and you have thoroughly examined your intent for paying
                a premium for time.
                <br />
                <br />I don't recommend going to a bootcamp as a shorcut into
                the industry. A bootcamp is no different than being self-taught
                or going to college. You will still need to
                <ul>
            ...
            >
              ...
              <p style={{ maxWidth: "100%", width: 700 }}>
                ...
                available to you. When it comes to questions like these, I
                recommend to critically examine reputation and accreditation.
                <br />
                ...
                predictors for a student's success in a classroom - exposure to
            ...
            >
              ...
              <p style={{ maxWidth: "100%", width: 700 }}>
                ...
                computation. Computation is problem solving. So coding expresses
                ...
                financial systems or just about anything you can think of. It's
                certainly a preferred game for entrepeneurs, but many people
                also take the well-balanced life approach with it too. So
                sometimes people code becasue they want a more relaxed life too.
              </p>
            </div>
            <br />
            <br />
            ...
            >
              ...
              <p style={{ maxWidth: "100%", width: 700 }}>
                ...
                experience some "rustyness" if you haven't done deep learning of
                a subject in some time, but that's not too different than a
                college student realizing that they need to learn how to learn.
                Maybe you already know how to learn or you understand what works
                for you. Now suddenly you have an advantage. This is a reason I
                suggest people spend time reflecting often, you'd be surprised
                how much empowerment you can draw from it.
                <br />
                <br />
                ...
                experience and execution will be valued more than innovation,
                speed and the tradeoffs that happen with it. As one of my
                directors say, slow is smooth and smooth is fast. This isn't to
                create any sense of superiority or inferiority - you're just in
                a competitive market and it's usually better to take the
                productive outlook.
              </p>
            </div>
            <br />
            ...
            >
              ...
              <p style={{ maxWidth: "100%", width: 700 }}>
                ...
                certification that I feel confident recommending is a UI/UX one
                with Nielsen Norman Group, but I would still suggest research
                beforehand too. Reddit tends to be a good place to gather
                consensus but be careful not to accept a few people's word as
                law either.
              </p>
            </div>
            <br />
            ...
            >
              ...
              <p style={{ maxWidth: "100%", width: 700 }}>
                ...
                finishing was not an option. While I was in school, I studied
                what early bootcamps were teaching. It was a different time and
                it helped me be less bored at school. I started working on
                RO.B.E in college to make my education more interesting.
                <br />
              </p>
            </div>
            <br />
            ...
            >
              ...
              <p style={{ maxWidth: "100%", width: 700 }}>
                I'm not in that kind of business. I talk about what I invest in
                and why.
                <br />
              </p>
            </div>
